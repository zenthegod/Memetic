...
<div id="container">
    <div id="main">
        ...
        <div id="header">
            <div id="left_bar_header"><span class="title" ><a href = "index.php">MEME</span><span class="title_dark">TIC</a></span>
                <p><b>The answer to your problem.</b></p>
            </div>
        </div>
        <div id="content">
            <div class="col-sm-12 text-center"><h1>Star Wars Memes</h1></div>
            <?php
            include 'GeneratePhotoGallery.php';
            $images_dir = 'Star Wars/';
            $thumbs_dir = 'Star Wars-thumb/';
            $thumbs_width = 100;
            $images_per_row = 3;
